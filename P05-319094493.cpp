...
int main()
{
	...
	Carroceria = Model();
	Carroceria.LoadModel("Models/incredimovil_carroceria.obj");
	LlantaDerecha = Model();
	LlantaDerecha.LoadModel("Models/incredimovil_llanta_der.obj");
	LlantaIzquierda = Model();
	LlantaIzquierda.LoadModel("Models/incredimovil_llanta_izq.obj");
	Cofre = Model();
	Cofre.LoadModel("Models/incredimovil_cofre.obj");
