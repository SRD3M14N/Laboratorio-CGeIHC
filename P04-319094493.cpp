...
int main()
{
	...
	*/
	...
	glm::mat4 modelauxRuedas(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía
	...
	while (!mainWindow.getShouldClose())
	{
		...
		// Crear ruedas
		{
			...
			model = glm::translate(model, glm::vec3(-1.9f, -4.0f, 3.0f));
			model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
			model = glm::scale(model, glm::vec3(1.9f, 1.3f, 1.9f));
			
			modelaux = model;
			model = glm::rotate(model, glm::radians(mainWindow.getNeumatico1()), glm::vec3(0.0f, 1.0f, 0.0f));
			glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
			color = glm::vec3(0.2f, 0.5f, 0.7f);
			glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
			...
			modelaux = model;
			model = glm::rotate(model, glm::radians(mainWindow.getNeumatico2()), glm::vec3(0.0f, 1.0f, 0.0f));
			glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
			meshList[2]->RenderMeshGeometry();
			model = modelaux;
			...
			modelaux = model;
			model = glm::rotate(model, glm::radians(mainWindow.getNeumatico3()), glm::vec3(0.0f, 1.0f, 0.0f));
			glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
			meshList[2]->RenderMeshGeometry();
			model = modelaux;
			...
			modelaux = model;
			model = glm::rotate(model, glm::radians(mainWindow.getNeumatico4()), glm::vec3(0.0f, 1.0f, 0.0f));
			glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
			meshList[2]->RenderMeshGeometry();

		}

		model = modelauxRuedas;
		...
		*/
		...
		Pierna izquierda frontal parte 1 - F
		Pierna izquierda frontal parte 2 - G

		Pierna izquierda intermedia parte 1 - H
		Pierna izquierda intermedia parte 2 - J

		Pierna izquierda trasera parte 1 - K
		Pierna izquierda trasera parte 2 - L

		Pierna derecha frontal parte 1 - X
		Pierna derecha frontal parte 2 - C

		Pierna derecha intermedia parte 1 - V
		Pierna derecha intermedia parte 2 - B

		Pierna derecha trasera parte 1 - N
		Pierna derecha trasera parte 2 - M
		...
		*/
		...
		
		{
			...
			// Cabeza
			{
				...
				// Ojo derecho inferior
				model = glm::translate(model, glm::vec3(-0.85f, 0.2f, -0.25f));
				...
				// Ojo derecho medio
				model = glm::translate(model, glm::vec3(0.5f, 1.0f, -0.8f));
				glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
				sp.render();

				// Ojo derecho superior
				model = glm::translate(model, glm::vec3(0.5f, 1.0f, -0.8f));
				glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
				sp.render();
			...
			// Piernas
			{
				// Pierna izquierda frontal
				{
					...
					model = glm::translate(model, glm::vec3(-2.0f, 1.3f, 1.5f));
					...
					model = glm::rotate(model, glm::radians(40.0f), glm::vec3(0.0f, 1.0f, 0.0f));
					model = glm::rotate(model, glm::radians(60.0f), glm::vec3(1.0f, 0.0f, 0.0f));
					model = glm::translate(model, glm::vec3(0.05f, -2.3f, 0.8f));
					...
					model = glm::scale(model, glm::vec3(0.1f, 0.1f, 5.0f));
					glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
					meshList[0]->RenderMesh(); //dibuja cubo, pirámide triangular, pirámide base cuadrangular
				...
				// Pierna izquierda trasera
				{
					...
					model = glm::translate(model, glm::vec3(0.0f, 1.3f, 1.8f));
					model = glm::rotate(model, glm::radians(-60.0f), glm::vec3(1.0f, 0.0f, 0.0f));
